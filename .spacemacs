...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font (list
	     "Source Code Pro"
	     :size  (if (memq window-system '(mac ns x)) 12 14)
	     :weight 'semibold
	     :width 'normal)
   ;; The leader key
